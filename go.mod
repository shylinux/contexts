...
require (
	shylinux.com/x/golang-story v0.5.0
	shylinux.com/x/linux-story v0.4.8
	shylinux.com/x/mysql-story v0.5.1
	shylinux.com/x/nginx-story v0.5.1
	shylinux.com/x/redis-story v0.5.2
)
